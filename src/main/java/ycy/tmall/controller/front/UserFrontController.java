package ycy.tmall.controller.front;
...
import ycy.tmall.controller.base.FrontBaseController;
...
public class UserFrontController extends FrontBaseController {
    ...
    public String loginIn(String name ,String password , Model model, HttpSession session,String refer) throws Exception {
